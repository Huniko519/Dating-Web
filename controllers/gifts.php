<?php
Class Gifts extends Theme {
    public static $page_data = array('title' => 'Gifts sent to me');
    public static $partial = 'gifts';
    public static function init_data() {
        ...
        parent::$data['gifts'] = self::GiftsData();
    }
    public static function show($partial = array()) {
        self::init_data();
        parent::show(self::$partial);
    }
    public static function GiftsData() {
        ...
        if (file_exists($ajax_class_file)) {
            ...
            $match_users   = $loadmore->gifts_users();
